  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-pink-700">Nossa História</h2>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-pink-50">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-pink-700">Missão, Visão e Valores</h2>
          </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col items-center space-y-4 text-center">
                  ...
                  <h3 className="text-xl font-bold text-pink-700">Missão</h3>
                  <p className="text-gray-600">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col items-center space-y-4 text-center">
                  ...
                  <h3 className="text-xl font-bold text-pink-700">Visão</h3>
                  <p className="text-gray-600">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col items-center space-y-4 text-center">
                  ...
                  <h3 className="text-xl font-bold text-pink-700">Valores</h3>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-pink-700">Nossa Equipe</h2>
            <p className="mx-auto max-w-[700px] text-gray-600 md:text-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-pink-700">Assistentes Sociais</h3>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-pink-700">Psicólogos</h3>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-pink-700">Pedagogos</h3>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-pink-700">Cuidadores</h3>
