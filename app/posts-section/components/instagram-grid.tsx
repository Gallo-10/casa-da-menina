    ...
    <div className="w-full max-w-6xl mx-auto relative">
      ...
      {currentPage > 0 && (
        <button
          ...
          className="absolute -left-20 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center w-10 h-10 rounded-full bg-white/90 shadow-lg hover:bg-white transition-colors"
        >
      ...
      {currentPage < totalPages - 1 && (
        <button
          ...
          aria-label="Próximo"
          onClick={goToNext}
          className="absolute -right-20 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center w-10 h-10 rounded-full bg-white/90 shadow-lg hover:bg-white transition-colors"
        >
